...
class wx_pay():
    ...
    def get_request_payment(self):
        ...
        pmStr = "appId="+ SETTINGS.APP_ID +"&nonceStr=" + self.nonceStr + "&package=prepay_id=" + ret['prepay_id'] + "&signType=MD5&timeStamp=" +  self.timeStamp + "&key=283fc3d9d4b8ba3b58601145466d4417"
